...
const Container = styled.div<Pick<MessageContentProps, "maxWidth" | "marginTop" | "marginBottom">>`
  display: flex;
...
export const MessageContent: React.FC<MessageContentProps> = ({
  ...
  return (
    <Container maxWidth={maxWidth} marginTop={marginTop} marginBottom={marginBottom}>
      <Text
